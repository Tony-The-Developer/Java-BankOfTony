...
public class Customer2ButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent e) {
        JFrame frame = new JFrame("Customer 2");
        JPanel customer2 = new JPanel();
        customer2.setLayout(new FlowLayout());
